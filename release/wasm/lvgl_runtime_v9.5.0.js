...
var ASM_CONSTS = {
  1209608: ($0) => { startToDebuggerMessage($0); },  
 1209640: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1209715: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1209790: ($0) => { finishToDebuggerMessage($0); },  
 1209823: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1209853: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1209883: ($0) => { lvglScreenTick($0); },  
 1209907: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1209947: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1210001: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1210055: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1210108: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1210161: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1210214: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1210266: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1210313: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1210346: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1210382: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1210427: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1210533: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1210569: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1210606: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1210646: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1210703: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1210762: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
