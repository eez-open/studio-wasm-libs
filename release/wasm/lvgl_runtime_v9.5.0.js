...
var ASM_CONSTS = {
  1208408: ($0) => { startToDebuggerMessage($0); },  
 1208440: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1208515: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1208590: ($0) => { finishToDebuggerMessage($0); },  
 1208623: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1208653: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1208683: ($0) => { lvglScreenTick($0); },  
 1208707: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1208747: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1208801: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1208855: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1208908: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1208961: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1209014: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1209066: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1209113: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1209146: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1209182: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1209227: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1209333: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1209369: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1209406: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1209446: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1209503: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1209562: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
