...
var ASM_CONSTS = {
  1209576: ($0) => { startToDebuggerMessage($0); },  
 1209608: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1209683: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1209758: ($0) => { finishToDebuggerMessage($0); },  
 1209791: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1209821: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1209851: ($0) => { lvglScreenTick($0); },  
 1209875: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1209915: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1209969: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1210023: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1210076: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1210129: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1210182: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1210234: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1210281: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1210314: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1210350: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1210395: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1210501: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1210537: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1210574: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1210614: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1210671: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1210730: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
