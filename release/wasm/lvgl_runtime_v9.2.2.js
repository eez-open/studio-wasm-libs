...
var ASM_CONSTS = {
  1182728: ($0) => { startToDebuggerMessage($0); },  
 1182760: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1182835: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1182910: ($0) => { finishToDebuggerMessage($0); },  
 1182943: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1182973: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1183003: ($0) => { lvglScreenTick($0); },  
 1183027: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1183067: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1183121: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1183175: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1183228: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1183281: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1183334: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1183386: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1183433: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1183466: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1183502: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1183547: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1183653: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1183689: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1183726: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1183766: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1183823: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1183882: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
