...
var ASM_CONSTS = {
 ...
 1159131: ($0, $1) => { js_dispatch_event($0, $1); },  
 1159162: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1159268: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1159304: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1159341: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1159381: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1159438: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1159497: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
