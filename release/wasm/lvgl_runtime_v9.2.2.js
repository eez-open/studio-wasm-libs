...
var ASM_CONSTS = {
  1185832: ($0) => { startToDebuggerMessage($0); },  
 1185864: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185939: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1186014: ($0) => { finishToDebuggerMessage($0); },  
 1186047: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1186077: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1186107: ($0) => { lvglScreenTick($0); },  
 1186131: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1186171: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1186225: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1186279: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1186332: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1186385: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1186438: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1186490: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1186537: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1186570: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1186606: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1186651: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1186757: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1186793: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1186830: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186870: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186927: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1186986: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
