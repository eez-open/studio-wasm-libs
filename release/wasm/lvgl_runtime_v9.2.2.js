...
var ASM_CONSTS = {
  1185848: ($0) => { startToDebuggerMessage($0); },  
 1185880: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185955: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1186030: ($0) => { finishToDebuggerMessage($0); },  
 1186063: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1186093: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1186123: ($0) => { lvglScreenTick($0); },  
 1186147: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1186187: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1186241: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1186295: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1186348: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1186401: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1186454: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1186506: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1186553: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1186586: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1186622: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1186667: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1186773: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1186809: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1186846: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186886: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186943: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1187002: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
