...
var ASM_CONSTS = {
  1201128: ($0) => { startToDebuggerMessage($0); },  
 1201160: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1201235: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1201310: ($0) => { finishToDebuggerMessage($0); },  
 1201343: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1201373: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1201403: ($0) => { lvglScreenTick($0); },  
 1201427: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1201467: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1201521: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1201575: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1201628: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1201681: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1201734: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1201786: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1201833: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1201866: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1201902: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1201947: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1202053: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1202089: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1202126: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1202166: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1202223: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1202282: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
