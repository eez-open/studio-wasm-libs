...
var ASM_CONSTS = {
  1199960: ($0) => { startToDebuggerMessage($0); },  
 1199992: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1200067: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1200142: ($0) => { finishToDebuggerMessage($0); },  
 1200175: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1200205: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1200235: ($0) => { lvglScreenTick($0); },  
 1200259: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1200299: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1200353: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1200407: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1200460: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1200513: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1200566: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1200618: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1200665: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1200698: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1200734: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1200779: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1200885: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1200921: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1200958: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1200998: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1201055: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1201114: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
