...
var ASM_CONSTS = {
 ...
 1046624: () => { js_dispatch_event(handler_id, e); },  
 1046662: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1046768: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1046804: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1046841: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1046881: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1046938: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1046997: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
