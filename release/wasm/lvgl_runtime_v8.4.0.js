...
var ASM_CONSTS = {
  1185576: ($0) => { startToDebuggerMessage($0); },  
 1185608: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185683: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185758: ($0) => { finishToDebuggerMessage($0); },  
 1185791: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1185821: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1185851: ($0) => { lvglScreenTick($0); },  
 1185875: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1185915: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1185969: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1186023: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1186076: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1186129: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1186182: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1186234: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1186281: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1186314: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1186350: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1186395: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1186501: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1186537: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1186574: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186614: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186671: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1186730: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
