...
var ASM_CONSTS = {
  1185000: ($0) => { startToDebuggerMessage($0); },  
 1185032: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185107: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185182: ($0) => { finishToDebuggerMessage($0); },  
 1185215: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1185245: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1185275: ($0) => { lvglScreenTick($0); },  
 1185299: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1185339: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1185393: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1185447: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1185500: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1185553: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1185606: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1185658: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1185705: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1185738: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1185774: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1185819: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1185925: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1185961: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1185998: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186038: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186095: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1186154: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
