...
var ASM_CONSTS = {
  1185560: ($0) => { startToDebuggerMessage($0); },  
 1185592: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185667: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185742: ($0) => { finishToDebuggerMessage($0); },  
 1185775: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1185805: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1185835: ($0) => { lvglScreenTick($0); },  
 1185859: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1185899: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1185953: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1186007: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1186060: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1186113: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1186166: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1186218: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1186265: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1186298: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1186334: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1186379: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1186485: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1186521: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1186558: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186598: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186655: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1186714: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
