...
var ASM_CONSTS = {
  1205032: ($0) => { startToDebuggerMessage($0); },  
 1205064: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1205139: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1205214: ($0) => { finishToDebuggerMessage($0); },  
 1205247: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1205277: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1205307: ($0) => { lvglScreenTick($0); },  
 1205331: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1205371: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1205425: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1205479: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1205532: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1205585: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1205638: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1205690: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1205737: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1205770: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1205806: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1205851: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1205957: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1205993: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1206030: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1206070: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1206127: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1206186: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
