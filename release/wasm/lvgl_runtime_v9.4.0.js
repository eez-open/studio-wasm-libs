...
var ASM_CONSTS = {
  1206216: ($0) => { startToDebuggerMessage($0); },  
 1206248: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206323: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206398: ($0) => { finishToDebuggerMessage($0); },  
 1206431: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1206461: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1206491: ($0) => { lvglScreenTick($0); },  
 1206515: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1206555: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1206609: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1206663: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1206716: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1206769: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1206822: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1206874: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1206921: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1206954: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1206990: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1207035: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1207141: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1207177: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1207214: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1207254: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1207311: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1207370: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
