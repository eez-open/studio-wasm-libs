...
var ASM_CONSTS = {
  1206232: ($0) => { startToDebuggerMessage($0); },  
 1206264: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206339: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206414: ($0) => { finishToDebuggerMessage($0); },  
 1206447: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1206477: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1206507: ($0) => { lvglScreenTick($0); },  
 1206531: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1206571: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1206625: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1206679: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1206732: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1206785: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1206838: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1206890: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1206937: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1206970: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1207006: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1207051: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1207157: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1207193: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1207230: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1207270: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1207327: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1207386: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
