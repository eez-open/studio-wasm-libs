 ...
 */
function evaluateCondition(condition, definesMap, notDefinedSet) {
 ...
 */
function parseDirective(line, lineIndex) {
 ...
 */
function findConditionalBlocks(lines) {
    const blocks = [];
    const stack = [];
 ...
 */
function processBlock(lines, block, definesMap, notDefinedSet) {
 ...
 */
function removeIncludes(lines, prefixes) {
 ...
 */
function cleanupSourceFile(content, defines, notDefined = [], removeIncludePrefixes = []) {
