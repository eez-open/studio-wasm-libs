...
const test1Result = cleanupSourceFile(test1Input, ["EEZ_FOR_LVGL"]);
console.log("Input:\n" + test1Input);
...
const test2Result = cleanupSourceFile(test2Input, ["EEZ_FOR_LVGL"]);
...
const test3Result = cleanupSourceFile(test3Input, ["EEZ_FOR_LVGL"]);
...
const test4Result = cleanupSourceFile(test4Input, ["EEZ_FOR_LVGL"]);
...
const test5Result = cleanupSourceFile(test5Input, ["EEZ_FOR_LVGL"]);
...
const test6Result = cleanupSourceFile(test6Input, ["EEZ_FOR_LVGL"]);
console.log("Result:\n" + test6Result);
...
const test7Result = cleanupSourceFile(test7Input, ["EEZ_FOR_LVGL"]);
console.log("Result:\n" + test7Result);
console.log("Expected:\n" + test7Expected);
...
const test8Result = cleanupSourceFile(test8Input, ["EEZ_FOR_LVGL"]);
...
const test9Result = cleanupSourceFile(test9Input, ["EEZ_FOR_LVGL"]);
console.log("Result:\n" + test9Result);
...
const test10Result = cleanupSourceFile(test10Input, ["EEZ_FOR_LVGL"]);
...
const test11Result = cleanupSourceFile(test11Input, ["EEZ_FOR_LVGL", "EEZ_FOR_LVGL_LZ4_OPTION"]);
...
const test12Result = cleanupSourceFile(test12Input, ["EEZ_FOR_LVGL"]);
...
const test13Result = cleanupSourceFile(test13Input, ["EEZ_FOR_LVGL"]);
...
const test14Result = cleanupSourceFile(test14Input, ["EEZ_FOR_LVGL"]);
...
const test15Result = cleanupSourceFile(test15Input, ["EEZ_FOR_LVGL"]);
...
const test16Result = cleanupSourceFile(test16Input, ["EEZ_FOR_LVGL"]);
...
const test17Result = cleanupSourceFile(test17Input, ["EEZ_FOR_LVGL"]);
console.log("Result:\n" + test17Result);
...
const test18Result = cleanupSourceFile(test18Input, ["EEZ_OPTION_GUI=0"]);
console.log("Result:\n" + test18Result);
...
const test19Result = cleanupSourceFile(test19Input, ["EEZ_OPTION_GUI=1"]);
console.log("Result:\n" + test19Result);
...
const test20Result = cleanupSourceFile(test20Input, ["EEZ_OPTION_GUI=0"]);
console.log("Result:\n" + test20Result);
...
const test21Result = cleanupSourceFile(test21Input, ["EEZ_OPTION_GUI=0"]);
console.log("Result:\n" + test21Result);
...
const test22Result = cleanupSourceFile(test22Input, ["EEZ_FOR_LVGL", "EEZ_OPTION_GUI=0"]);
console.log("Result:\n" + test22Result);
...
const test23Result = cleanupSourceFile(test23Input, ["EEZ_FOR_LVGL", "EEZ_OPTION_GUI=1"]);
console.log("Result:\n" + test23Result);
...
const test24Result = cleanupSourceFile(test24Input, ["EEZ_FOR_LVGL"], ["EEZ_PLATFORM_STM32"]);
console.log("Result:\n" + test24Result);
...
const test25Result = cleanupSourceFile(test25Input, ["EEZ_FOR_LVGL"], ["EEZ_PLATFORM_STM32"]);
console.log("Result:\n" + test25Result);
...
const test26Result = cleanupSourceFile(test26Input, ["EEZ_FOR_LVGL"], ["EEZ_PLATFORM_STM32"]);
console.log("Result:\n" + test26Result);
...
const test27Result = cleanupSourceFile(test27Input, ["EEZ_FOR_LVGL"], ["EEZ_PLATFORM_STM32"]);
console.log("Result:\n" + test27Result);
...
const test28Result = cleanupSourceFile(test28Input, ["EEZ_FOR_LVGL"], ["EEZ_DASHBOARD_API"]);
console.log("Result:\n" + test28Result);
...
const test29Result = cleanupSourceFile(test29Input, [], [], ["eez/"]);
console.log("Result:\n" + test29Result);
...
const test30Result = cleanupSourceFile(test30Input, [], [], ["eez/"]);
console.log("Result:\n" + test30Result);
...
const test31Result = cleanupSourceFile(test31Input, [], [], ["eez/", "lvgl/"]);
console.log("Result:\n" + test31Result);
...
const test32Result = cleanupSourceFile(test32Input, ["EEZ_FOR_LVGL"], [], ["eez/"]);
console.log("Result:\n" + test32Result);
...
const test33Result = cleanupSourceFile(test33Input, []);
console.log("Result:\n" + test33Result);
...
const test34Result = cleanupSourceFile(test34Input, []);
console.log("Result:\n" + test34Result);
...
const test35Result = cleanupSourceFile(test35Input, []);
console.log("Result:\n" + test35Result);
...
const test36Result = cleanupSourceFile(test36Input, [], ["NOT_DEFINED"]);
console.log("Result:\n" + test36Result);
...
const test37Result = cleanupSourceFile(test37Input, 
    // defines
    [
        "EEZ_FOR_LVGL",
        "EEZ_OPTION_GUI=0",
